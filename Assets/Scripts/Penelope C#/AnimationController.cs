...
public class AnimationController : MonoBehaviour
{
    ...
    private float minUpwardSpeed = 2.0f;
        ...
        } else if (speed > 0)
        {
            ...
            if (Mathf.Abs(forwardMotion) > Mathf.Abs(sidewaysMotion))
            {
                ...
                else
                {
                    ...
                    animationTarget ["runback"].speed = Mathf.Lerp(0.25f, 1.0f, t);
            ...
            else
            {
                ...
                if (sidewaysMotion > 0)
                {
                    animationTarget ["runright"].speed = Mathf.Lerp(0.25f, 1.0f, t);
                    animationTarget.CrossFade("runright");                
                } 
                else
                {
                    animationTarget ["runleft"].speed = Mathf.Lerp(0.25f, 1.0f, t);
